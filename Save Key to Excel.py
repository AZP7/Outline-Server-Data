...
wb = Workbook()
ws = wb.active
ws.title = "Shadowsocks Keys"

# Header
ws.append(["Port", "Password", "Key"])

# Data rows
for port, password in config["port_password"].items():
    ws.append([port, password, keys[port]])

# Save file
excel_path = "/home/welcome/E/Project/Python/Outline-Server-Data/outline_keys.xlsx"
wb.save(excel_path)

print("✅ outline_keys.xlsx created successfully!")
